      ...
      >
        ...
        <Flex direction={"column"} gap={"1"} w={"90%"}>
          <Text fontWeight={"semibold"} fontSize={"sm"}>
            Metadatify experienced an error while attempting to access the requested resource.
          </Text>
          <Text fontSize={"xs"}>
        ...
        <Button onClick={() => navigate(0)} size={"xs"} rounded={"md"} variant={"subtle"} colorPalette={"red"}>
          Reload Page
