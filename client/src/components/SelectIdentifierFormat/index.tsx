 ...
 */
const SelectIdentifierFormat = (props: SelectIdentifierFormatProps) => {
  ...
  return (
    <Flex direction={"row"} gap={"2"} w={"100%"}>
      ...
      <DialogCreateIdentifierFormat open={open} onClose={() => setOpen(false)} onCreated={handleFormatCreated} />
    </Flex>
  );
};

export default SelectIdentifierFormat;
