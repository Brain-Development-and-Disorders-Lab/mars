          ...
          <Flex direction={"row"} gap={"1"}>
            ...
            >
              ...
              <Flex direction={"row"} gap={"1"} w={"100%"}>
                ...
                {nameUseCounter && <CounterSelect counter={counter} setCounter={onCounterChange} showCreate />}
                <Button
                  size={"xs"}
                  rounded={"md"}
                  colorPalette={"blue"}
        ...
        <Fieldset.Content>
          <Flex direction={"row"} gap={"1"}>
            ...
            <Field.Root w={"50%"} gap={"0.5"}>
              ...
              <IdentifierFormatSelect format={identifierFormat} setFormat={onIdentifierFormatChange} showCreate />
            </Field.Root>
          </Flex>
        </Fieldset.Content>
      </Fieldset.Root>
