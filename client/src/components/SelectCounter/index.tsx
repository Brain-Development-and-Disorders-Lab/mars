...
// Custom types
import { CounterModel, SelectCounterProps, ISelectOption, ResponseData } from "@types";
...
const SelectCounter = (props: SelectCounterProps) => {
  // Counter state
  ...
  return (
    <Flex direction={"column"} gap={"1"} w={"100%"}>
      ...
      <DialogCreateCounter open={open} onClose={() => setOpen(false)} onCreated={handleCounterCreated} />
    </Flex>
  );
};
