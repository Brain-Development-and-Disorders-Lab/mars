...
// Custom types
import { CreateCustomIdentifierFormatDialogProps, IIdentifierFormat, ResponseData } from "@types";
 ...
 */
const CreateIdentifierFormatDialog = (props: CreateCustomIdentifierFormatDialogProps) => {
  // Workspace
...
export default CreateIdentifierFormatDialog;
