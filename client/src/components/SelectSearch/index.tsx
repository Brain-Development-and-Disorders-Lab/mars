...
// Custom types
import { EntityModel, IconNames, IGenericItem, SelectSearchProps } from "@types";
...
const SelectSearch = (props: SelectSearchProps) => {
  ...
  const getSelectOptions = async () => {
    const optionFetchers: Record<SelectSearchProps["resultType"], () => Promise<void>> = {
