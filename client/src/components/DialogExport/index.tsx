...
const DialogExport = (props: DialogExportProps) => {
  ...
  const handleDownload = async () => {
    ...
    const exporters: Record<DialogExportProps["dataType"], () => Promise<{ data?: string; filename: string }>> = {
      entity: async () => {
                          ...
                          <Checkbox.Root checked disabled size={"xs"}>
                            ...
                            <Checkbox.Label>
                              <Flex direction={"row"} gap={"0.5"} align={"center"}>
                                ...
                                <TagActor identifier={entity.owner} inlineNoAvatar fallback={""} size={"sm"} />
                              </Flex>
                            </Checkbox.Label>
                          </Checkbox.Root>
                          <Checkbox.Root
                        ...
                        >
                          ...
                          <Checkbox.Label>
                            <Flex direction={"row"} gap={"0.5"} align={"center"}>
                              ...
                              <TagActor identifier={project.owner} inlineNoAvatar fallback={""} size={"sm"} />
                            </Flex>
                          </Checkbox.Label>
                        </Checkbox.Root>
                        <Checkbox.Root
