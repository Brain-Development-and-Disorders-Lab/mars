...
import DialogCompareAttribute from "@components/DialogCompareAttribute";
import Icon from "@components/Icon";
import Linky from "@components/Linky";
import Values from "@components/Values";

// Existing and custom types
import { AttributeModel, DialogViewAttributeProps } from "@types";
...
const DialogViewAttribute = (props: DialogViewAttributeProps) => {
  ...
  // Current working state, used to inform `DialogCompareAttribute` state
...
export default DialogViewAttribute;
