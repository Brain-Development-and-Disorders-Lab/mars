...
// Custom types
import { DialogCreateCounterProps, ICounter, ResponseData } from "@types";
 ...
 */
const DialogCreateCounter = (props: DialogCreateCounterProps) => {
...
export default DialogCreateCounter;
