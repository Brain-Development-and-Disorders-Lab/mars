...
// Target component
import TagVisibility from "../../src/components/TagVisibility";
...
const renderVisibilityTag = (props: Partial<React.ComponentProps<typeof TagVisibility>> = {}) => {
  const defaultProps = {
    isPublic: true,
    setIsPublic: vi.fn(),
    isInherited: false,
  ...
  return render(<TagVisibility {...defaultProps} />);
};

describe("TagVisibility Component", () => {
